...
struct CResHelperTemplatedCResTLK2018;
...
struct CCallbackManualTemplatedCSteamInternalUserStatsReceived_tfalse;
...
struct CCallbackTemplatedCSteamInternalUserStatsReceived_tfalse;
...
struct CExoArrayListTemplatedCExoNetInternal__PendingAddressTranslationPtr;
...
struct CExoArrayListTemplatedNWSync__CNWSync__MappingBatchInsertEntry;
struct CExoArrayListTemplatedNWSync__CNWSync__ResRefBatchInsertEntry;
struct CExoArrayListTemplatedNWSync__StorageProviderPtr;
...
struct Curl_message;
struct Curl_mime_contenttype__ContentType;
struct Curl_multi;
