    ...
    : CNWArea, CResHelperTemplatedCResARE2012u, CGameObject
{
    ...
    void SaveAreaEffects(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveCreatures(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveDoors(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveEncounters(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveGIT(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveGIT(CERFFile*, CExoString&, CExoArrayListTemplatedunsignedlong&);
    void SaveItems(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SavePlaceables(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveProperties(CResGFF*, CResStruct*);
    void SaveSounds(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveStores(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveTriggers(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
    void SaveWaypoints(CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
...
void CNWSArea__CNWSAreaCtor(CNWSArea* thisPtr, CResRef, int32_t, uint32_t);
...
int32_t CNWSArea__LoadArea(CNWSArea* thisPtr, int32_t);
...
void CNWSArea__SaveAreaEffects(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveCreatures(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveDoors(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveEncounters(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveGIT__0(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveGIT__1(CNWSArea* thisPtr, CERFFile*, CExoString&, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveItems(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SavePlaceables(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveProperties(CNWSArea* thisPtr, CResGFF*, CResStruct*);
void CNWSArea__SaveSounds(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveStores(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveTriggers(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
void CNWSArea__SaveWaypoints(CNWSArea* thisPtr, CResGFF*, CResStruct*, CExoArrayListTemplatedunsignedlong&);
