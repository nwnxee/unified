...
void CResRef__CResRefCtor__1(CResRef* thisPtr, const CExoString&);
void CResRef__CResRefCtor__2(CResRef* thisPtr, const char*);
void CResRef__CResRefCtor__3(CResRef* thisPtr, const unsigned char*);
void CResRef__CResRefCtor__4(CResRef* thisPtr, const unsigned char*, unsigned char);
