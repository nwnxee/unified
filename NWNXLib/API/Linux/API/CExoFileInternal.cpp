...
{
    CExoFileInternal__CExoFileInternalCtor__1(this, a0, a1);
}

CExoFileInternal::CExoFileInternal(const CExoString& a0, uint16_t a1, const CExoString& a2)
{
    CExoFileInternal__CExoFileInternalCtor__2(this, a0, a1, a2);
}
...
void CExoFileInternal__CExoFileInternalCtor__1(CExoFileInternal* thisPtr, const void* a0, int32_t a1)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoFileInternal*, const void*, int32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoFileInternal__CExoFileInternalCtor__1);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0, a1);
}

void CExoFileInternal__CExoFileInternalCtor__2(CExoFileInternal* thisPtr, const CExoString& a0, uint16_t a1, const CExoString& a2)
{
