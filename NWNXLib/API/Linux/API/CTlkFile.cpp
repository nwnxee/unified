...
{
    CTlkFile__CTlkFileCtor__1(this, a0, a1);
}
...
void CTlkFile__CTlkFileCtor__1(CTlkFile* thisPtr, const void* a0, int32_t a1)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CTlkFile*, const void*, int32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CTlkFile__CTlkFileCtor__1);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0, a1);
}
