...
void CExoStringList__CExoStringListCtor__1(CExoStringList* thisPtr, CExoStringList*);
void CExoStringList__CExoStringListCtor__2(CExoStringList* thisPtr, int32_t, int32_t, int32_t);
