...
struct CNetLayer
{
    ...
    int32_t GetEnumerateSpecificOverRelay();
...
int32_t CNetLayer__GetPlayerAddressRelayed(CNetLayer* thisPtr, uint32_t);
...
uint32_t CNetLayer__GetSessionSectionStart(CNetLayer* thisPtr, uint32_t);
