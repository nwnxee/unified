...
{
    CTlkResFile__CTlkResFileCtor(this, a0);
}
...
void CTlkResFile__CTlkResFileCtor(CTlkResFile* thisPtr, const CResRef& a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CTlkResFile*, const CResRef&);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CTlkResFile__CTlkResFileCtor);
