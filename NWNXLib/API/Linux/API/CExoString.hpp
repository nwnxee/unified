...
struct CExoString
{
    ...
    static CExoString FormatBytes(uint64_t);
    static CExoString FormatDuration(uint64_t);
    int32_t GetLength();
    ...
    CExoString Strip(int32_t, int32_t, const char*);
...
CExoString CExoString__FormatBytes(uint64_t);
CExoString CExoString__FormatDuration(uint64_t);
...
CExoString CExoString__Strip(CExoString* thisPtr, int32_t, int32_t, const char*);
