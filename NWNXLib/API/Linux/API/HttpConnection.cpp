...
{
    HttpConnection__HttpConnectionCtor(this);
}

HttpConnection::~HttpConnection()
{
    HttpConnection__HttpConnectionDtor(this);
}
...
void HttpConnection__HttpConnectionCtor(HttpConnection* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::HttpConnection__HttpConnectionCtor);
...
void HttpConnection__HttpConnectionDtor(HttpConnection* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::HttpConnection__HttpConnectionDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
