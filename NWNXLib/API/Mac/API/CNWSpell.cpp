...
CNWSpell& CNWSpell::operator=(const CNWSpell&)
{
...
CNWSpell::CNWSpell()
{
    CNWSpell__CNWSpellCtor__0(this);
}

CNWSpell::CNWSpell(const CNWSpell& a0)
{
    CNWSpell__CNWSpellCtor__2(this, a0);
}

CNWSpell::~CNWSpell()
{
    CNWSpell__CNWSpellDtor__0(this);
}
...
void CNWSpell__CNWSpellCtor__0(CNWSpell* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSpell__CNWSpellCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CNWSpell__CNWSpellCtor__2(CNWSpell* thisPtr, const CNWSpell& a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSpell*, const CNWSpell&);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSpell__CNWSpellCtor__2);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0);
}
...
void CNWSpell__CNWSpellDtor__0(CNWSpell* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSpell__CNWSpellDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
