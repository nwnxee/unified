...
void CExoFileInternal__CExoFileInternalCtor__2(CExoFileInternal* thisPtr, const void*, int32_t);
void CExoFileInternal__CExoFileInternalCtor__4(CExoFileInternal* thisPtr, const CExoString&, uint16_t, const CExoString&);
