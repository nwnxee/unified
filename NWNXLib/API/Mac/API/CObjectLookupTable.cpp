...
CObjectLookupTable::~CObjectLookupTable()
{
    CObjectLookupTable__CObjectLookupTableDtor__0(this);
}
...
void CObjectLookupTable__CObjectLookupTableCtor__0(CObjectLookupTable* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CObjectLookupTable*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CObjectLookupTable__CObjectLookupTableCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CObjectLookupTable__CObjectLookupTableDtor__0(CObjectLookupTable* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CObjectLookupTable*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CObjectLookupTable__CObjectLookupTableDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
