...
{
    CNWBaseItemArray__CNWBaseItemArrayCtor__0(this);
}

CNWBaseItemArray::~CNWBaseItemArray()
{
    CNWBaseItemArray__CNWBaseItemArrayDtor__0(this);
}
...
void CNWBaseItemArray__CNWBaseItemArrayCtor__0(CNWBaseItemArray* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWBaseItemArray__CNWBaseItemArrayCtor__0);
...
void CNWBaseItemArray__CNWBaseItemArrayDtor__0(CNWBaseItemArray* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWBaseItemArray__CNWBaseItemArrayDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
