...
{
    CNWSSoundObject__CNWSSoundObjectCtor__0(this, a0);
}
...
void CNWSSoundObject__CNWSSoundObjectCtor__0(CNWSSoundObject* thisPtr, uint32_t a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSSoundObject*, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSSoundObject__CNWSSoundObjectCtor__0);
