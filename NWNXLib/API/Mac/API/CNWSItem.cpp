...
CNWSItem::CNWSItem(const CNWSItem&)
{
    __builtin_trap(); // This is an auto-generated stub. You probably shouldn't use it.
}

CNWSItem& CNWSItem::operator=(const CNWSItem&)
{
    __builtin_trap(); // This is an auto-generated stub. You probably shouldn't use it.
}
...
{
    CNWSItem__CNWSItemCtor__0(this, a0);
}
...
void CNWSItem__CNWSItemCtor__0(CNWSItem* thisPtr, uint32_t a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSItem*, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSItem__CNWSItemCtor__0);
