...
{
    CAppManager__CAppManagerCtor__0(this);
}

CAppManager::~CAppManager()
{
    CAppManager__CAppManagerDtor__0(this);
}
...
void CAppManager__CAppManagerCtor__0(CAppManager* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CAppManager__CAppManagerCtor__0);
...
void CAppManager__CAppManagerDtor__0(CAppManager* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CAppManager__CAppManagerDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
