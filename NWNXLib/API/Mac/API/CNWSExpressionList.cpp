...
CNWSExpressionList::~CNWSExpressionList()
{
    CNWSExpressionList__CNWSExpressionListDtor__0(this);
}
...
void CNWSExpressionList__CNWSExpressionListCtor__0(CNWSExpressionList* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSExpressionList__CNWSExpressionListCtor__0);
...
void CNWSExpressionList__CNWSExpressionListDtor__0(CNWSExpressionList* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSExpressionList__CNWSExpressionListDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
