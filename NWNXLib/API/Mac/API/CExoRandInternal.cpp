...
CExoRandInternal::~CExoRandInternal()
{
    CExoRandInternal__CExoRandInternalDtor__0(this);
}
...
void CExoRandInternal__CExoRandInternalCtor__0(CExoRandInternal* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoRandInternal*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoRandInternal__CExoRandInternalCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CExoRandInternal__CExoRandInternalDtor__0(CExoRandInternal* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoRandInternal*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoRandInternal__CExoRandInternalDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
