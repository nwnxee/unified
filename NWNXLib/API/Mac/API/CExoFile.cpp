...
{
    CExoFile__CExoFileCtor__2(this, a0, a1);
}

CExoFile::CExoFile(const CExoString& a0, uint16_t a1, const CExoString& a2)
{
    CExoFile__CExoFileCtor__4(this, a0, a1, a2);
}
...
void CExoFile__CExoFileCtor__2(CExoFile* thisPtr, const void* a0, int32_t a1)
{
...
void CExoFile__CExoFileCtor__4(CExoFile* thisPtr, const CExoString& a0, uint16_t a1, const CExoString& a2)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoFile*, const CExoString&, uint16_t, const CExoString&);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoFile__CExoFileCtor__4);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
