...
void CERFKey__CERFKeyCtor__0(CERFKey* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CERFKey__CERFKeyCtor__0);
...
void CERFKey__CERFKeyDtor__0(CERFKey* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CERFKey__CERFKeyDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
