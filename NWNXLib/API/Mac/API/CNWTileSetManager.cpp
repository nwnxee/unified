...
CNWTileSetManager::~CNWTileSetManager()
{
    CNWTileSetManager__CNWTileSetManagerDtor__0(this);
}
...
void CNWTileSetManager__CNWTileSetManagerCtor__0(CNWTileSetManager* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWTileSetManager*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWTileSetManager__CNWTileSetManagerCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CNWTileSetManager__CNWTileSetManagerDtor__0(CNWTileSetManager* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWTileSetManager*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWTileSetManager__CNWTileSetManagerDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
