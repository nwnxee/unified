...
void C2DA__C2DACtor__2(C2DA* thisPtr, CResRef a0, int32_t a1)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(C2DA*, CResRef, int32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::C2DA__C2DACtor__2);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0, a1);
}
