...
{
    CExoAliasList__CExoAliasListCtor__0(this);
}

CExoAliasList::~CExoAliasList()
{
    CExoAliasList__CExoAliasListDtor__0(this);
}
...
void CExoAliasList__CExoAliasListCtor__0(CExoAliasList* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoAliasList__CExoAliasListCtor__0);
...
void CExoAliasList__CExoAliasListDtor__0(CExoAliasList* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoAliasList__CExoAliasListDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
