...
{
    CNWSArea__CNWSAreaCtor__0(this, a0, a1, a2);
}
...
void CNWSArea__CNWSAreaCtor__0(CNWSArea* thisPtr, CResRef a0, int32_t a1, uint32_t a2)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSArea*, CResRef, int32_t, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSArea__CNWSAreaCtor__0);
