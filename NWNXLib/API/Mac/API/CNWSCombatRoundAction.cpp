...
CNWSCombatRoundAction::CNWSCombatRoundAction(const CNWSCombatRoundAction&)
{
    __builtin_trap(); // This is an auto-generated stub. You probably shouldn't use it.
}

CNWSCombatRoundAction& CNWSCombatRoundAction::operator=(const CNWSCombatRoundAction&)
{
    __builtin_trap(); // This is an auto-generated stub. You probably shouldn't use it.
}
...
{
    CNWSCombatRoundAction__CNWSCombatRoundActionCtor__0(this);
}

CNWSCombatRoundAction::~CNWSCombatRoundAction()
{
    CNWSCombatRoundAction__CNWSCombatRoundActionDtor__0(this);
}
...
void CNWSCombatRoundAction__CNWSCombatRoundActionCtor__0(CNWSCombatRoundAction* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSCombatRoundAction__CNWSCombatRoundActionCtor__0);
...
void CNWSCombatRoundAction__CNWSCombatRoundActionDtor__0(CNWSCombatRoundAction* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSCombatRoundAction__CNWSCombatRoundActionDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
