...
{
    HttpBuffer__HttpBufferCtor__0(this, a0, a1, a2, a3);
}

HttpBuffer::~HttpBuffer()
{
    HttpBuffer__HttpBufferDtor__0(this);
}

void HttpBuffer::AddResponseHeader(const CExoString& a0, const CExoString& a1)
{
    return HttpBuffer__AddResponseHeader(this, a0, a1);
}
...
void HttpBuffer__HttpBufferCtor__0(HttpBuffer* thisPtr, const CExoString& a0, void* a1, HttpBufferReceiver* a2, uint32_t a3)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(HttpBuffer*, const CExoString&, void*, HttpBufferReceiver*, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::HttpBuffer__HttpBufferCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0, a1, a2, a3);
}

void HttpBuffer__HttpBufferDtor__0(HttpBuffer* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(HttpBuffer*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::HttpBuffer__HttpBufferDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}

void HttpBuffer__AddResponseHeader(HttpBuffer* thisPtr, const CExoString& a0, const CExoString& a1)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(HttpBuffer*, const CExoString&, const CExoString&);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::HttpBuffer__AddResponseHeader);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0, a1);
}
