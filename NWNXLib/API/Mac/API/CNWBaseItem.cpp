...
{
    CNWBaseItem__CNWBaseItemCtor__0(this);
}

CNWBaseItem::~CNWBaseItem()
{
    CNWBaseItem__CNWBaseItemDtor__0(this);
}
...
void CNWBaseItem__CNWBaseItemCtor__0(CNWBaseItem* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWBaseItem*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWBaseItem__CNWBaseItemCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CNWBaseItem__CNWBaseItemDtor__0(CNWBaseItem* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWBaseItem*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWBaseItem__CNWBaseItemDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
