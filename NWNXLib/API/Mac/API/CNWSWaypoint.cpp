...
void CNWSWaypoint__CNWSWaypointCtor__0(CNWSWaypoint* thisPtr, uint32_t a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSWaypoint*, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSWaypoint__CNWSWaypointCtor__0);
