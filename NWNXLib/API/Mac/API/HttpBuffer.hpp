...
struct HttpBuffer
{
    ...
    ~HttpBuffer();
    void AddResponseHeader(const CExoString&, const CExoString&);
...
void HttpBuffer__HttpBufferCtor__0(HttpBuffer* thisPtr, const CExoString&, void*, HttpBufferReceiver*, uint32_t);
void HttpBuffer__HttpBufferDtor__0(HttpBuffer* thisPtr);
void HttpBuffer__AddResponseHeader(HttpBuffer* thisPtr, const CExoString&, const CExoString&);
