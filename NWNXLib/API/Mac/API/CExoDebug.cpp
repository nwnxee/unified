...
CExoDebug::CExoDebug()
{
    CExoDebug__CExoDebugCtor__0(this);
}

CExoDebug::~CExoDebug()
{
    CExoDebug__CExoDebugDtor__0(this);
}
...
void CExoDebug__CExoDebugCtor__0(CExoDebug* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoDebug*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoDebug__CExoDebugCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CExoDebug__CExoDebugDtor__0(CExoDebug* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoDebug*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoDebug__CExoDebugDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
