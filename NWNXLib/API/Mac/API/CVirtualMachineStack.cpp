...
CVirtualMachineStack::~CVirtualMachineStack()
{
    CVirtualMachineStack__CVirtualMachineStackDtor__0(this);
}
...
void CVirtualMachineStack__CVirtualMachineStackCtor__0(CVirtualMachineStack* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CVirtualMachineStack__CVirtualMachineStackCtor__0);
...
void CVirtualMachineStack__CVirtualMachineStackDtor__0(CVirtualMachineStack* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CVirtualMachineStack__CVirtualMachineStackDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
