...
CExoKeyTable::~CExoKeyTable()
{
    CExoKeyTable__CExoKeyTableDtor__0(this);
}
...
void CExoKeyTable__CExoKeyTableCtor__0(CExoKeyTable* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoKeyTable__CExoKeyTableCtor__0);
...
void CExoKeyTable__CExoKeyTableDtor__0(CExoKeyTable* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoKeyTable__CExoKeyTableDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
