...
{
    CResRef__CResRefCtor__4(this, a0);
}

CResRef::CResRef(const unsigned char* a0)
{
    CResRef__CResRefCtor__6(this, a0);
}

CResRef::CResRef(const unsigned char* a0, unsigned char a1)
{
    CResRef__CResRefCtor__8(this, a0, a1);
}
...
void CResRef__CResRefCtor__2(CResRef* thisPtr, const CExoString& a0)
{
...
void CResRef__CResRefCtor__4(CResRef* thisPtr, const char* a0)
{
...
void CResRef__CResRefCtor__6(CResRef* thisPtr, const unsigned char* a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CResRef*, const unsigned char*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CResRef__CResRefCtor__6);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0);
}

void CResRef__CResRefCtor__8(CResRef* thisPtr, const unsigned char* a0, unsigned char a1)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CResRef*, const unsigned char*, unsigned char);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CResRef__CResRefCtor__8);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0, a1);
}
