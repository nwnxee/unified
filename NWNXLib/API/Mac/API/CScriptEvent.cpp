...
CScriptEvent::CScriptEvent(const CScriptEvent&)
{
    __builtin_trap(); // This is an auto-generated stub. You probably shouldn't use it.
}

CScriptEvent& CScriptEvent::operator=(const CScriptEvent&)
{
    __builtin_trap(); // This is an auto-generated stub. You probably shouldn't use it.
}
...
{
    CScriptEvent__CScriptEventCtor__0(this);
}

CScriptEvent::~CScriptEvent()
{
    CScriptEvent__CScriptEventDtor__0(this);
}
...
void CScriptEvent__CScriptEventCtor__0(CScriptEvent* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptEvent__CScriptEventCtor__0);
...
void CScriptEvent__CScriptEventDtor__0(CScriptEvent* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptEvent__CScriptEventDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
