...
{
    CScriptCompiler__CScriptCompilerCtor__0(this);
}

CScriptCompiler::~CScriptCompiler()
{
    CScriptCompiler__CScriptCompilerDtor__0(this);
}
...
void CScriptCompiler__CScriptCompilerCtor__0(CScriptCompiler* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptCompiler__CScriptCompilerCtor__0);
...
void CScriptCompiler__CScriptCompilerDtor__0(CScriptCompiler* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptCompiler__CScriptCompilerDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
