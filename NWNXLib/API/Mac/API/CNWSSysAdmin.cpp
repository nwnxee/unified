...
void CNWSSysAdmin__CNWSSysAdminCtor__0(CNWSSysAdmin* thisPtr, uint32_t a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSSysAdmin*, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSSysAdmin__CNWSSysAdminCtor__0);
