...
void CNWSModule__CNWSModuleCtor__0(CNWSModule* thisPtr, CExoString a0, int32_t a1, int32_t a2)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSModule*, CExoString, int32_t, int32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSModule__CNWSModuleCtor__0);
