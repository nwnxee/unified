...
{
    CNWSDoor__CNWSDoorCtor__0(this, a0);
}
...
void CNWSDoor__CNWSDoorCtor__0(CNWSDoor* thisPtr, uint32_t a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSDoor*, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSDoor__CNWSDoorCtor__0);
