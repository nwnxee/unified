...
{
    CScriptLocation__CScriptLocationCtor__0(this);
}

CScriptLocation::~CScriptLocation()
{
    CScriptLocation__CScriptLocationDtor__0(this);
}
...
void CScriptLocation__CScriptLocationCtor__0(CScriptLocation* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptLocation__CScriptLocationCtor__0);
...
void CScriptLocation__CScriptLocationDtor__0(CScriptLocation* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptLocation__CScriptLocationDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
