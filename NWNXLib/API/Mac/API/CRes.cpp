...
void CRes__CResCtor__2(CRes* thisPtr, uint32_t a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CRes*, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CRes__CResCtor__2);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0);
}
