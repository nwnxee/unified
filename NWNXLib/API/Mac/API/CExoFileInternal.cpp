...
{
    CExoFileInternal__CExoFileInternalCtor__0(this, a0, a1, a2);
}
...
void CExoFileInternal__CExoFileInternalCtor__0(CExoFileInternal* thisPtr, const CExoString& a0, uint16_t a1, const CExoString& a2)
{
