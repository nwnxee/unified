...
void CExoFile__CExoFileCtor__2(CExoFile* thisPtr, const void*, int32_t);
void CExoFile__CExoFileCtor__4(CExoFile* thisPtr, const CExoString&, uint16_t, const CExoString&);
