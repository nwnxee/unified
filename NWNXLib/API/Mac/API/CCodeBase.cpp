...
CCodeBase::CCodeBase()
{
    CCodeBase__CCodeBaseCtor__0(this);
}

CCodeBase::~CCodeBase()
{
    CCodeBase__CCodeBaseDtor__0(this);
}
...
void CCodeBase__CCodeBaseCtor__0(CCodeBase* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CCodeBase__CCodeBaseCtor__0);
...
void CCodeBase__CCodeBaseDtor__0(CCodeBase* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CCodeBase__CCodeBaseDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
