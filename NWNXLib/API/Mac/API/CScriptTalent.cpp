...
{
    CScriptTalent__CScriptTalentCtor__0(this);
}

CScriptTalent::~CScriptTalent()
{
    CScriptTalent__CScriptTalentDtor__0(this);
}
...
void CScriptTalent__CScriptTalentCtor__0(CScriptTalent* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CScriptTalent*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptTalent__CScriptTalentCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CScriptTalent__CScriptTalentDtor__0(CScriptTalent* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CScriptTalent*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CScriptTalent__CScriptTalentDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
