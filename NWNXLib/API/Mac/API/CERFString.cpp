...
CERFString::~CERFString()
{
    CERFString__CERFStringDtor__0(this);
}
...
void CERFString__CERFStringCtor__0(CERFString* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CERFString__CERFStringCtor__0);
...
void CERFString__CERFStringDtor__0(CERFString* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CERFString__CERFStringDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
