...
void CExoArrayListTemplatedCNetLayerPlayerCDKeyInfo::SetSize(int32_t a0)
{
    return CExoArrayListTemplatedCNetLayerPlayerCDKeyInfo__SetSize(this, a0);
}
...
void CExoArrayListTemplatedCNetLayerPlayerCDKeyInfo__SetSize(CExoArrayListTemplatedCNetLayerPlayerCDKeyInfo* thisPtr, int32_t a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoArrayListTemplatedCNetLayerPlayerCDKeyInfo*, int32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoArrayListTemplatedCNetLayerPlayerCDKeyInfo__SetSize);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    return func(thisPtr, a0);
}
