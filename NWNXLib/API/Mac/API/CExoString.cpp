...
CExoString::~CExoString()
{
    CExoString__CExoStringDtor__0(this);
}
...
void CExoString__CExoStringCtor__2(CExoString* thisPtr, int32_t a0)
{
...
void CExoString__CExoStringCtor__4(CExoString* thisPtr, const CExoString& a0)
{
...
void CExoString__CExoStringCtor__6(CExoString* thisPtr, const char* a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoString*, const char*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoString__CExoStringCtor__6);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0);
}
...
void CExoString__CExoStringDtor__0(CExoString* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoString__CExoStringDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
