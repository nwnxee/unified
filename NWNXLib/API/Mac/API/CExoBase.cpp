...
CExoBase::~CExoBase()
{
    CExoBase__CExoBaseDtor__0(this);
}
...
void CExoBase__CExoBaseCtor__0(CExoBase* thisPtr, CExoString a0)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoBase*, CExoString);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoBase__CExoBaseCtor__0);
...
void CExoBase__CExoBaseDtor__0(CExoBase* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoBase__CExoBaseDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
