...
CServerExoAppInternal::~CServerExoAppInternal()
{
    CServerExoAppInternal__CServerExoAppInternalDtor__0(this);
}
...
void CServerExoAppInternal__CServerExoAppInternalCtor__0(CServerExoAppInternal* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CServerExoAppInternal__CServerExoAppInternalCtor__0);
...
void CServerExoAppInternal__CServerExoAppInternalDtor__0(CServerExoAppInternal* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CServerExoAppInternal__CServerExoAppInternalDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
