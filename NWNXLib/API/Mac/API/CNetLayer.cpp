...
CNetLayer::CNetLayer()
{
    CNetLayer__CNetLayerCtor__0(this);
}

CNetLayer::~CNetLayer()
{
    CNetLayer__CNetLayerDtor__0(this);
}
...
void CNetLayer__CNetLayerCtor__0(CNetLayer* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNetLayer__CNetLayerCtor__0);
...
void CNetLayer__CNetLayerDtor__0(CNetLayer* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNetLayer__CNetLayerDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
...
{
    using FuncPtrType = int32_t(__attribute__((cdecl)) *)(CNetLayer*, uint32_t, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__attribute__((cdecl)) *)(CNetLayer*, uint32_t, int32_t, unsigned char*, uint16_t, int32_t, uint32_t);
