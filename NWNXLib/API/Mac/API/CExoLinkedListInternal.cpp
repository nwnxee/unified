...
void CExoLinkedListInternal__CExoLinkedListInternalDtor__0(CExoLinkedListInternal* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoLinkedListInternal*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoLinkedListInternal__CExoLinkedListInternalDtor__0);
