...
{
    CExoStringList__CExoStringListCtor__2(this, a0);
}

CExoStringList::CExoStringList(int32_t a0, int32_t a1, int32_t a2)
{
    CExoStringList__CExoStringListCtor__4(this, a0, a1, a2);
}

CExoStringList::~CExoStringList()
{
    CExoStringList__CExoStringListDtor__0(this);
}
...
void CExoStringList__CExoStringListCtor__2(CExoStringList* thisPtr, CExoStringList* a0)
{
...
void CExoStringList__CExoStringListCtor__4(CExoStringList* thisPtr, int32_t a0, int32_t a1, int32_t a2)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CExoStringList*, int32_t, int32_t, int32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoStringList__CExoStringListCtor__4);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
...
void CExoStringList__CExoStringListDtor__0(CExoStringList* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoStringList__CExoStringListDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
