...
{
    CNWSJournal__CNWSJournalCtor__0(this);
}

CNWSJournal::~CNWSJournal()
{
    CNWSJournal__CNWSJournalDtor__0(this);
}
...
void CNWSJournal__CNWSJournalCtor__0(CNWSJournal* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSJournal*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSJournal__CNWSJournalCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CNWSJournal__CNWSJournalDtor__0(CNWSJournal* thisPtr)
{
    using FuncPtrType = void(__attribute__((cdecl)) *)(CNWSJournal*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSJournal__CNWSJournalDtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
