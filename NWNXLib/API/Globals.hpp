...
constexpr uintptr_t g_exoBaseAddr        = 0x004707E0; NWNX_EXPECT_VERSION(8155);
constexpr uintptr_t g_exoResManAddr      = 0x004707DC; NWNX_EXPECT_VERSION(8155);
constexpr uintptr_t g_virtualMachineAddr = 0x004707D8; NWNX_EXPECT_VERSION(8155);
constexpr uintptr_t g_scriptCompilerAddr = 0x004707D4; NWNX_EXPECT_VERSION(8155);
