...
//   NWNX_HOOK_LANDING_* = Calling covention we should use in landing functions for the hook.
    ...
    #define NWNX_HOOK_PLATFORM_SYSTEMV
    ...
    #define NWNX_HOOK_POINTER_SYSTEMV NWNX_HOOK_PLATFORM_SYSTEMV
    ...
    #define NWNX_HOOK_LANDING_SYSTEMV NWNX_HOOK_PLATFORM_SYSTEMV
#else
...
#define NWNX_HOOK_POINTER_CALL_SYSTEMV(...) __VA_ARGS__
// End parameters
...
#define NWNX_HOOK_LANDING_PARAMETERS_SYSTEMV(...) __VA_ARGS__
// End parameters
