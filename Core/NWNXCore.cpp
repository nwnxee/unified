...
extern "C" void nwnx_signal_handler(int sig)
{
    ...
    std::fprintf(stderr, " NWNX Signal Handler:\n"
        ...
        "==============================================================\n",
        NWNX_TARGET_NWN_BUILD, NWNX_TARGET_NWN_BUILD_REVISION, NWNX_TARGET_NWN_BUILD_SHA, err, sig);
      ...
      m_ScriptChunkRecursion(0)
{
    ...
    std::printf("Starting NWNX %d.%d [%s]\n", NWNX_TARGET_NWN_BUILD, NWNX_TARGET_NWN_BUILD_REVISION, NWNX_TARGET_NWN_BUILD_SHA);
