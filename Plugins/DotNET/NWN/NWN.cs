...
namespace NWN
{
    public partial class Effect
    {
        ...
        ~Effect() { Internal.NativeFunctions.FreeGameDefinedStructure(NWScript.ENGINE_STRUCTURE_EFFECT, Handle); }
    ...
    public partial class Event
    {
        ...
        ~Event() { Internal.NativeFunctions.FreeGameDefinedStructure(NWScript.ENGINE_STRUCTURE_EVENT, Handle); }
    ...
    public partial class Location
    {
        ...
        ~Location() { Internal.NativeFunctions.FreeGameDefinedStructure(NWScript.ENGINE_STRUCTURE_LOCATION, Handle); }
    ...
    public partial class Talent
    {
        ...
        ~Talent() { Internal.NativeFunctions.FreeGameDefinedStructure(NWScript.ENGINE_STRUCTURE_TALENT, Handle); }
    ...
    public partial class ItemProperty
    {
        ...
        ~ItemProperty() { Internal.NativeFunctions.FreeGameDefinedStructure(NWScript.ENGINE_STRUCTURE_ITEM_PROPERTY, Handle); }
    ...
    public partial class SQLQuery
    {
      ...
      ~SQLQuery() { Internal.NativeFunctions.FreeGameDefinedStructure(NWScript.ENGINE_STRUCTURE_SQL_QUERY, Handle); }
