// Generated on 2018-03-24 11:22:54 -0400
...
You can optionally specify a reason to override the text shown to the player.
     */
    public static synchronized void bootPC(NWObject oPlayer, String sReason) throws NWNotInContextException {
...
Note that creature needs to be a player@param or player-possessed creature.
...
1: Tile was explored before setting newState.
     */
    public static synchronized int setTileExplored(NWObject creature, NWObject area, int x, int y, int newState) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setTileExplored");
        pushInteger(newState);
        pushInteger(y);
        pushInteger(x);
        pushObject(area);
        pushObject(creature);
...
1: Tile is explored.
     */
    public static synchronized int getTileExplored(NWObject creature, NWObject area, int x, int y) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getTileExplored");
        pushInteger(y);
        pushInteger(x);
        pushObject(area);
        pushObject(creature);
...
Returns the previous state (or -1 if non-creature).
     */
    public static synchronized int setCreatureExploresMinimap(NWObject creature, int newState) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setCreatureExploresMinimap");
        pushInteger(newState);
        pushObject(creature);
        callFunction(868, 2);
        return popInteger();
...
Returns FALSE if creature is not actually a creature.
     */
    public static synchronized int getCreatureExploresMinimap(NWObject creature) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getCreatureExploresMinimap");
        pushObject(creature);
        callFunction(869, 1);
        return popInteger();
    }
...
Returns 0 if the location is invalid or has no surface type.
     */
    public static synchronized int getSurfaceMaterial(NWLocation at) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getSurfaceMaterial");
        pushLocation(at);
        callFunction(870, 1);
        return popInteger();
    }
...
Returns -6.0 for invalid locations.
     */
    public static synchronized float getGroundHeight(NWLocation at) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getGroundHeight");
        pushLocation(at);
        callFunction(871, 1);
        return popFloat();
    }
...
@param The default value is 20.
     */
    public static synchronized int getAttackBonusLimit() throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getAttackBonusLimit");
        callFunction(872, 0);
        return popInteger();
    }
...
@param The default value is 100.
     */
    public static synchronized int getDamageBonusLimit() throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getDamageBonusLimit");
        callFunction(873, 0);
        return popInteger();
    }
...
@param The default value is 20.
     */
    public static synchronized int getSavingThrowBonusLimit() throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getSavingThrowBonusLimit");
        callFunction(874, 0);
        return popInteger();
    }
...
@param The default value is 12.
     */
    public static synchronized int getAbilityBonusLimit() throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getAbilityBonusLimit");
        callFunction(875, 0);
        return popInteger();
    }
...
@param The default value is 30.
     */
    public static synchronized int getAbilityPenaltyLimit() throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getAbilityPenaltyLimit");
        callFunction(876, 0);
        return popInteger();
    }
...
@param The default value is 50.
     */
    public static synchronized int getSkillBonusLimit() throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getSkillBonusLimit");
        callFunction(877, 0);
        return popInteger();
    }
...
@param The minimum value is 0.
     */
    public static synchronized void setAttackBonusLimit(int nNewLimit) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setAttackBonusLimit");
        pushInteger(nNewLimit);
        callFunction(878, 1);
    }
...
@param The minimum value is 0.
     */
    public static synchronized void setDamageBonusLimit(int nNewLimit) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setDamageBonusLimit");
        pushInteger(nNewLimit);
        callFunction(879, 1);
    }
...
@param The minimum value is 0.
     */
    public static synchronized void setSavingThrowBonusLimit(int nNewLimit) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setSavingThrowBonusLimit");
        pushInteger(nNewLimit);
        callFunction(880, 1);
    }
...
@param The minimum value is 0.
     */
    public static synchronized void setAbilityBonusLimit(int nNewLimit) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setAbilityBonusLimit");
        pushInteger(nNewLimit);
        callFunction(881, 1);
    }
...
@param The minimum value is 0.
     */
    public static synchronized void setAbilityPenaltyLimit(int nNewLimit) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setAbilityPenaltyLimit");
        pushInteger(nNewLimit);
        callFunction(882, 1);
    }
...
@param The minimum value is 0.
     */
    public static synchronized void setSkillBonusLimit(int nNewLimit) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setSkillBonusLimit");
        pushInteger(nNewLimit);
        callFunction(883, 1);
    }
...
Returns FALSE for any other object, including OBJECT_INVALID.
     */
    public static synchronized boolean getIsPlayerConnectionRelayed(NWObject oPlayer) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getIsPlayerConnectionRelayed");
        pushObject(oPlayer);
        callFunction(884, 1);
        return popInteger() > 0;
    }
...
have the requested handler.
     */
    public static synchronized String getEventScript(NWObject oObject, int nHandler) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling getEventScript");
        pushInteger(nHandler);
        pushObject(oObject);
        callFunction(885, 2);
        return popString();
    }
...
Will fail if oObject is invalid or does not have the requested handler.
     */
    public static synchronized int setEventScript(NWObject oObject, int nHandler, String sScript) throws NWNotInContextException {
        if (!canCallVM()) throw new NWNotInContextException("Not on VM thread while calling setEventScript");
        pushString(sScript);
        pushInteger(nHandler);
        pushObject(oObject);
        callFunction(886, 3);
