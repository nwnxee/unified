...
public class Scheduler {
    ...
    private static void assignSet(NWObject obj, List<Runnable> anon) {
        ...
        NWScript.setLocalString(NWObject.MODULE, "NWNX_JVM_TOKEN", token.toString());
        NWScript.setLocalString(NWObject.MODULE, "NWNX_JVM_TOKEN_TYPE", "execute");
        NWScript.executeScript("nwnx_jvm_token", obj);
    }
    ...
    private static void delaySet(NWObject obj, long delay, List<Runnable> anon) {
        ...
        NWScript.setLocalString(NWObject.MODULE, "NWNX_JVM_TOKEN", token.toString());
        NWScript.setLocalString(NWObject.MODULE, "NWNX_JVM_TOKEN_TYPE", "delay");
        NWScript.setLocalFloat(NWObject.MODULE, "NWNX_JVM_TOKEN_DELAY", f_delay);
        NWScript.executeScript("nwnx_jvm_token", obj);
    }
