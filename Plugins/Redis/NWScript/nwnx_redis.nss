// Autogenerated on: 2018-12-02 16:25:31 +0100
#include "nwnx"
 ...
 * Annotated return value: 
 */
string NWNX_Redis_CLIENT_UNBLOCK(
	string client_id,
	// Redis type: enum
	string unblock_type = ""
);
 ...
 * Annotated return value: 
 */
string NWNX_Redis_CLUSTER_REPLICAS(
	string node_id
);
 ...
 * Annotated return value: bulk-string
 */
string NWNX_Redis_MEMORY_DOCTOR();
 ...
 * Annotated return value: bulk-string
 */
string NWNX_Redis_MEMORY_MALLOC_STATS();
 ...
 * Annotated return value: simple-string
 */
string NWNX_Redis_MEMORY_PURGE();
