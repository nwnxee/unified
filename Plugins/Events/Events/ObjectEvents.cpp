...
static void CloseInventoryHook(CNWSPlaceable*, ObjectID);
...
void CloseInventoryHook(CNWSPlaceable *thisPtr, ObjectID oidCloser)
{
    ...
    s_CloseInventoryHook->CallOriginal<int32_t>(thisPtr, oidCloser);
